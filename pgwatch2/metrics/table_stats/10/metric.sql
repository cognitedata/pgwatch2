with recursive /* pgwatch2_generated */
    ...
    q_tstats as (
        ...
        limit 50 /* NB! When changing the bottom final LIMIT also adjust this limit. Should be at least 5x bigger as approx sizes depend a lot on vacuum frequency.
...
order by table_size_b desc nulls last limit 20; -- for Cognite
